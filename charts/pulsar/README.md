...
> **Note**
>
> This Apache Pulsar Helm Chart has been deprecated and we recommend using [streamnative/sn-platform](https://github.com/streamnative/charts/tree/master/charts/sn-platform) to provision and manage the Apache Pulsar on Kubernetes.
