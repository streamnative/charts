...
vault write identity/entity name="super-service-account" policies="super-service-account" metadata=system=true
...
vault write auth/userpass/users/$superUser password="$superPassword" policies="super-user" metadata=system=true
