...
if [ -n "$organization" ] && [ -n "$instance" ];then
    ...
    echo $serviceAccountClientId,$superServiceAccountClientId,$instanceSuperServiceAccountClientId,$organizationServiceAccountClientId,$userClientId,$superUserClientId
else
...
echo "" > /tmp/pm_env
if [ -n "$organization" ] && [ -n "$instance" ];then
    echo "PULSAR_PREFIX_OIDCTokenAudienceID="$serviceAccountClientId,$superServiceAccountClientId,$userClientId,$superUserClientId,$instanceSuperServiceAccountClientId,$organizationServiceAccountClientId >> /tmp/pm_env
else
