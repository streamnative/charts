...
vault write identity/oidc/key/service-account name=service-account rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL
...
vault write identity/oidc/key/service-account name=service-account rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL allowed_client_ids=$serviceAccountClientId
...
vault write identity/oidc/key/super-service-account name=super-service-account rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL
...
vault write identity/oidc/key/super-service-account name=super-service-account rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL allowed_client_ids=$superServiceAccountClientId
...
vault write identity/oidc/key/super-user name=super-user rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL
...
vault write identity/oidc/key/super-user name=super-user rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL allowed_client_ids=$superUserClientId

vault policy write user $TMP_DIR/user.hcl
vault write identity/entity name="user" policies="user"
vault write identity/oidc/key/user name=user rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL
...
vault write identity/oidc/key/user name=user rotation_period=$TOTATION_PERIOD verification_ttl=$VERIFICATION_TTL allowed_client_ids=$userClientId
